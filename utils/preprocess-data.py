...
def read_all_data(train_file='paraphrases.tsv', test_file='paraphrases_gold.tsv'):
...
def main():
    ...
    # emb_file = os.path.join(os.path.expanduser('~'), ' glove.840B.300d.sst.txt')
    emb_file = 'glove.840B.300d.sst.txt'
    filtered_emb, word2idx = idx_and_emb(tokenized, emb_file, 300)
    print('Embedding done.')
    
    with open('paraphrases_emb', 'wb') as f:
